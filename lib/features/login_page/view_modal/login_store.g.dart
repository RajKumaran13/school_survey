...
mixin _$LoginStore on _LoginStore, Store {
  ...
  late final _$sendResetEmailAsyncAction =
      AsyncAction('_LoginStore.sendResetEmail', context: context);

  @override
  Future<bool> sendResetEmail(String resetEmail) {
    return _$sendResetEmailAsyncAction
        .run(() => super.sendResetEmail(resetEmail));
  }
